...
# the R_code folder has three parts
# 1. 2020-cluster.R file
# 2. input folder that contains the data file we will use
# 3. output folder that contains the figures generated 
...
df <- read_csv(file.path("input", "pyrite_samples.csv"))
